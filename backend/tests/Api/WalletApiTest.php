...
final class WalletApiTest extends ApiTestCase
{
    ...
    {
        $this->requestJson('GET', '/api/wallets');
    ...
    public function testIndexWithTokenReturnsArray(): void
    {
        ...
        $this->requestJson('GET', '/api/wallets', token: self::TEST_USER_TOKEN);
    ...
    public function testCreateWithoutNameReturns422(): void
    {
        ...
        $this->requestJson('POST', '/api/wallets', [], self::TEST_USER_TOKEN);
    ...
    public function testShowUnknownIdReturns404(): void
    {
        ...
        $this->requestJson('GET', '/api/wallets/999999', token: self::TEST_USER_TOKEN);
