...
namespace App\Home\Report\Entity;
...
#[ORM\Entity(repositoryClass: CommonAccountSettlementConfigRepository::class)]
#[ORM\Table(name: 'common_account_settlement_config')]
#[ORM\HasLifecycleCallbacks]
class CommonAccountSettlementConfig
{
    ...
    #[ORM\JoinColumn(name: 'common_account_party_id', nullable: true, onDelete: 'SET NULL')]
    private ?Party $commonAccountParty = null;
    ...
    {
        return [
            'commonAccountPartyId'  => $this->commonAccountParty?->getId(),
    ...
    {
        return $this->commonAccountParty !== null && $this->homeBudgetWallet !== null;
    }
    ...
    public function getCommonAccountParty(): ?Party { return $this->commonAccountParty; }
    public function setCommonAccountParty(?Party $party): static { $this->commonAccountParty = $party; return $this; }
