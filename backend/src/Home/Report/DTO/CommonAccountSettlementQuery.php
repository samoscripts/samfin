...
final readonly class CommonAccountSettlementQuery
{
    ...
    public static function fromInputBag(InputBag $query): self|QueryValidationErrors
    {
        ...
        if ($query->has('nextDepositor') && $query->get('nextDepositor') !== '') {
            ...
            if (!in_array($raw, [CommonAccountSettlementConfig::DEPOSITOR_MACIEK, CommonAccountSettlementConfig::DEPOSITOR_BASIA], true)) {
