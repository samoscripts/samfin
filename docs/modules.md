...
| `Report/ReportSaved/Entity/ReportSaved.php` | — | Encja `report_saved` (nazwa unikalna per użytkownik i typ) |
| `Report/Shared/DTO/ReportPeriodResolver.php` | — | Wspólna walidacja okresu raportów (otwarte zakresy dat) |
