...
export default function BreakdownGroupTransactions({
  ...
  const netAmount =
    ...
    bothDirections && group.expenses != null && group.income != null
        ...
        <div className="flex-1 min-w-0">
          ...
          {bothDirections && group.expenses != null && group.income != null ? (
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              ...
              Wydatek {formatAmount(group.expenses)} · Wpływ {formatAmount(group.income)}

              {netAmount != null && (

                <> · Bilans {formatAmount(netAmount)}</>

              )}

              {' · '}

              {group.itemCount} pozycji
