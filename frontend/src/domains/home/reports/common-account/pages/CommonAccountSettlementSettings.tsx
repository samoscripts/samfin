...
export default function CommonAccountSettlementSettings() {
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <fieldset className="space-y-4">
        ...
        <label className="block text-sm text-gray-600 dark:text-gray-400">
          Konto wspólne (Dokąd wpłat / Skąd wydatków)
          <div className="mt-1">
            <DictionarySelect
              items={parties}
              value={draft.commonAccountPartyId ?? ''}
              onChange={(id) => setDraft((p) => ({
                ...p,
                commonAccountPartyId: id == null ? null : Number(id),
              }))}
